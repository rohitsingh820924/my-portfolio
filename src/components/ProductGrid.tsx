...
{Array.from({ length: 10 }, (_, i) => (
      ...
      >
        <div className="flex items-center justify-center w-full min-h-[8rem] bg-gray-300 rounded dark:bg-gray-900">
        ...
        <div>
          <div className="h-5 bg-gray-200 rounded dark:bg-gray-700 w-full mb-2"></div>
          <div className="h-5 bg-gray-200 rounded dark:bg-gray-700 w-2/3"></div>
        </div>
