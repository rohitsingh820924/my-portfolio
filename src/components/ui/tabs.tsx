...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row items-center gap-3 justify-start [perspective:1000px] relative overflow-auto sm:overflow-visible no-scrollbar max-w-full w-full",
          containerClassName
        )}
      >
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 bg-gray-200 dark:bg-neutral-950 rounded-full ",
                  activeTabClassName
                )}
              />
            )}
